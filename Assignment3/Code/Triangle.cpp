...
//Set the vertex (u,v) coordinates, for texture getting
...
std::array<Vector4f, 3> Triangle::toVector4() const
{
    ...
    return res;
}//unknown, seeming to be useless


//normals -> 3 normal elements  normals[0],[1],[2]: Corresponding to the vertex v[0],v[1],v[2]
...
{
    auto first_color = colors[0];//Don't know its usage.

    //Vertex, v[0], v[1], v[2]'s color.

    //colors[0] -> one color,  attached [0]/[1]/[2]: This color's r,g,b
